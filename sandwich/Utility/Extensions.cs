...
public static class Extensions
{
    ...
    public static bool IsCuttingBoardable(this ItemSlot slot) => slot?.Itemstack?.Collectible?.Attributes?[CuttingBoardable].AsBool() == true;
    public static bool IsCuttingBoardable(this CollectibleObject obj) => obj?.Attributes?[CuttingBoardable].AsBool() == true;
    ...
    public static List<ItemStack> CollectStacksForInteraction(this ICoreClientAPI capi, EnumStorageOption option)
    {
        ...
        {
            if ((option is EnumStorageOption.CuttingBoardable && !obj.IsCuttingBoardable()))
            {
                continue;
            }
